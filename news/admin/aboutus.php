...
if($query)
{
$msg="درباره ما به درستی تغییر یافت";
}
else{
$error="مشکلی به وجود امد دوباره تلاش کنید";
}
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title> پنل مدیریت | صفحه درباره ما</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">درباره ما </h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>توضیحات صفحه</b></h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">آپدیت و ارسال</button>
