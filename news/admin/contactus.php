...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>پنل مدیریت | صفحه تماس با ما</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">صفحه تماس باما  </h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>متن صفحه</b></h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">ارسال و ویرایش</button>
