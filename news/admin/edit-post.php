...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>پنل کاربری | ویرایش خبر</title>
...
<div class="form-group m-b-20">
<label for="exampleInputEmail1">زیردسته</label>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>عکس ارسالی</b></h4>
<img src="postimages/<?php echo htmlentities($row['PostImage']);?>" width="300"/>
<br />
<a href="change-image.php?pid=<?php echo htmlentities($row['postid']);?>">ارسال عکس</a>
</div>
</div>
</div>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">ویرایش </button>
