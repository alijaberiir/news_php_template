...
if($_GET['action']=='perdel' && $_GET['scid'])
{
	...
	$delmsg="دسته به طور کامل حذف شد";
}
...
<html lang="en">
    <head>
        ...
        <title> مدیرت پنل | مدیریت زیر دسته ها</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">مدیریت زیر دذسته ها</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">مدیریت زیر دسته ها</a>
                                        </li>
                                        <li>
                                            <a href="#">زیردسته ها </a>
                                        </li>
...
<strong>انجام شد!</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
...
<td colspan="7" align="center"><h3 style="color:red">موردی یافت نشد</h3></td>
<tr>
<?php
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> زیر دسته های حذف شده</h4>
