...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>پنل مدیریت | مدیریت اخبار</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">اخبار پیشنویس </h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">اخبار پیش نویس</a>
                                        </li>
                                        <li>
                                            <a href="#">اخبار</a>
                                        </li>
...
<td colspan="4" align="center"><h3 style="color:red">هیچ موردی یافت نشد</h3></td>
<tr>
<?php 
} else {
