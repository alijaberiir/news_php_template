  <div class="col-md-4">
        ...
        <input type="text" name="searchtitle" class="form-control" placeholder="...جستجو کن" required>
                <span class="input-group-btn">
                  <button class="btn btn-secondary" type="submit">بگرد</button>
                </span>
              </form>
              </div>
            </div>
...
<?php } ?>
          ...
          <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header">اخبار اخیر</h5>
            <div class="card-body">
                      <ul class="mb-0">
<?php
